...
parser.add_argument('--CONTENT_WEIGHT', type=int, default=17, help='CONTENT WEIGHT')
parser.add_argument('--STYLE_WEIGHT', type=int, default=50, help='STYLE WEIGHT')
parser.add_argument('--ADAM_LR', type=float, default=0.001, help='initial learning rate for adam')
